  ...
  return (
    <div className="bg-background min-h-screen flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1518709268805-4e9042af9f23?q=80&w=2000')] bg-cover bg-center opacity-20"></div>
      ...
      <main className="relative z-10 w-full max-w-[480px] px-6 py-12">
        <div className="flex flex-col items-center mb-10">
          <h1 className="font-headline text-3xl font-extrabold tracking-tighter text-primary mb-2">Explore Costa Rica Tours</h1>
          <p className="text-on-surface-variant font-medium">Begin your curated tropical journey</p>
        </div>

        <div className="glass-panel rounded-xl shadow-[0_20px_50px_rgba(0,0,0,0.06)] p-8 md:p-10">
          <form className="flex flex-col gap-6" onSubmit={handleSubmit}>
            <div className="flex flex-col gap-2">
              <label className="text-sm font-semibold text-primary/80 px-1" htmlFor="full_name">Full Name</label>
              <input
            ...
            <div className="flex flex-col gap-2">
              <label className="text-sm font-semibold text-primary/80 px-1" htmlFor="reg_email">Email</label>
              <input
                className="w-full bg-surface-container-high border-none rounded-lg px-4 py-3.5 text-on-surface focus:ring-2 focus:ring-primary/20 focus:bg-surface-container-highest transition-all duration-300 outline-none"
                id="reg_email"
                name="email"
            ...
            <div className="flex flex-col gap-2">
              <label className="text-sm font-semibold text-primary/80 px-1" htmlFor="reg_password">Password</label>
            ...
            <div className="flex flex-col gap-2">
              <label className="text-sm font-semibold text-primary/80 px-1" htmlFor="confirm_password">Confirm Password</label>
              <input
                className="w-full bg-surface-container-high border-none rounded-lg px-4 py-3.5 text-on-surface focus:ring-2 focus:ring-primary/20 focus:bg-surface-container-highest transition-all duration-300 outline-none"
                id="confirm_password"
